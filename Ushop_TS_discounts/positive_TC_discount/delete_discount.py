...
def delete_discount():
    ...
    select_item.click()
    delete_01= wait.until(EC.element_to_be_clickable((By.XPATH,'//*[@id="body"]/body/div[1]/div/form/div[3]/button[2]')))
    delete_01.click()
    time.sleep(2)
    delete_02 = wait.until(EC.element_to_be_clickable((By.XPATH,'//*[@id=":r0:"]/div/div/div/div/button[2]')))
    delete_02.click()
    time.sleep(2)
